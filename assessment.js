...
function removeItem(arrStrings, string){
	for(var i = arrStrings.length; i >= 0; i--) {
		if(arrStrings[i] === string){
...
function makeChatMessage(chatMessage, authorName){
var obj = {
	message: chatMessage,
	author: authorName,
	timestamp: new Date()
...
//Jeremy and then changes the person object to have a property called lovesCode with a value of 10.  If their name is
 // Brack set lovesCode to 0.  otherwise set lovesCode to 5.
